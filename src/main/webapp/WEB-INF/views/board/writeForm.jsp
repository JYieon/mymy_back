...
<body>
	...
	<form method="post" action="${pageContext.request.contextPath}/board/writeSave">
    <input class="form-control" placeholder="제목" style="width:100%" name="title" required/>
    <!-- 공개 여부 선택 -->
    <label for="boardOpen">공개 여부:</label>
    <select id="boardOpen" name="boardOpen" class="form-control">
